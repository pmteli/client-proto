		...
		{
            console.log("Running table script");
			$('.dynamicTable').each(function()
			{
				// DataTables with TableTools
				if ($(this).hasClass('tableTools'))
				{
                    console.log("Running tableTools code");
					$(this).dataTable({
				...
				else if ($(this).hasClass('colVis'))
				{
                    console.log("Running colVis code from public/script");
					$(this).dataTable({
                        "aaSorting": [[ 4, "desc" ]],
						"sPaginationType": "bootstrap",
				...
				else if ($(this).hasClass('scrollVertical'))
				{
					$(this).dataTable({
						"bPaginate": false,
						"sScrollY": "200px",
				...
				else if ($(this).hasClass('fixedHeaderColReorder'))
				{
					$(this).dataTable({
						"sPaginationType": "bootstrap",
